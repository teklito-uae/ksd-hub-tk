                  ...
                  <div className="p-4 md:p-5 flex flex-col h-full space-y-4">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center justify-between mb-0.5">
                          ...
                          <p className="text-[9px] font-bold text-muted-foreground uppercase opacity-60 flex items-center gap-0.5">
                            <MapPin className="size-2.5" /> {pro.location}
                          </p>
                        </div>
                    ...
                    <div className="flex items-center gap-3 pt-3 border-t border-gray-50">
                      ...
                      <div className="flex flex-col">
                        ...
                        <span className="text-[10px] font-black text-secondary">{pro.projects}+</span>
                      </div>
                      <div className="flex-1" />
                      <div className="flex flex-wrap gap-1 justify-end">
                        {pro.skills.slice(0, 2).map(skill => (
                          <Badge key={skill} className="bg-gray-50 text-secondary text-[8px] font-bold border-none px-1.5 h-4">
                            {skill}
                          </Badge>
                        ))}
                      </div>
