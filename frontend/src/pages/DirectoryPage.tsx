...
export function DirectoryPage() {
  ...
  const activeCategory = useMemo(() => 
    categories.find(c => c.id.toString() === selectedCategory?.toString()), 
  ...
  const filteredBusinesses = useMemo(() => {
    let results = businesses.filter((b) => {
      ...
      const matchesCategory = selectedCategory ? b.category_id?.toString() === selectedCategory?.toString() : true;
      const matchesLocation =
        selectedLocation === 'All Locations' ? true : b.location_city === selectedLocation;
